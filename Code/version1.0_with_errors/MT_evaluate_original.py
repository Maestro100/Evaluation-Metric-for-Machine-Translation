...
def new_winF(): # new window definition
    ...
    newwin.geometry('{}x{}'.format(600, 400))

    fname_label1 = Label(newwin, text="Have an excel file named 'Sentences.xlsx' ")
    fname_label2 = Label(newwin, text="in the same directory as the application")
    ...
    fname_label1.grid(row=0,column=0)
    fname_label2.grid(row=1,column=0)
