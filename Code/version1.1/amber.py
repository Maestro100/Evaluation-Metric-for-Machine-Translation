...
def amber(ref,trans):
    ...
    return net_score
#print amber("Consequently , we find no merit in the writ petition and it is accordingly dismissed " ,  "Resulting , We do not see any gunagun in the writ petition and consequently it is rejected.")
